...
{
	/// <summary> The interface describes a functionality of an iterator that enumerates all components of particular entity </summary>
	public interface IComponentIterator
	{
		/// <summary> The method returns component's value which the iterator points to </summary>
		...
		/// <summary> The method returns a reference to IComponent which the iterator points to </summary>
		/// <returns>The method returns a reference to IComponent which the iterator points to</returns>
		IComponent Get();
		
		/// <summary> The method moves iterator to next available component if the latter exists </summary>
