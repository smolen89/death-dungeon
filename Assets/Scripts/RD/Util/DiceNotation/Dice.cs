...
{
	/// <summary>
	/// The Dice class is a static class that has convenience method for parsing and rolling dice.
	/// </summary>
	public static class Dice
	{
		...
		/// <summary>
		/// Parse the specified string into DiceExpression.
		/// </summary>
		...
		{
			return Roll( expression, Globals.DefaultRandom );
		}
	}
}